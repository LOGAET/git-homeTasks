...
# 1.2 Проверка файла (решение через аргумент указано в скрипте task1_2.sh)
echo ""
...
echo "fg %1 - вывести задачу 1 на передний план (работает внутри интерактивной сессии)"
echo "bg %1 - возобновить задачу 1 в фоне (работает внутри интерактивной сессии)"
